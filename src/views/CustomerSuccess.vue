<template>
    <div>
      ...
      -->
      <section class="section has-text-centered p-b-5">
        <h3 class="title is-3 sr-up">What customers are saying about ETW</h3>
        <h4 class="subtitle has-text-grey sr-up-delay">Testimonials and Success Stories</h4>
      </section>
        ...
        <div class="container">
          <div class="columns is-centered is-multiline">
            <div class="column is-4-desktop is-10-tablet m-b-2 sr-up-interval" v-for="primaryTestimonial in testimonials" v-bind:key="primaryTestimonial.company">
              <article class="media">
                <figure class="media-left is-rounded">
                  <p class="image is-96x96">
                    <img v-bind:src="primaryTestimonial.headshot || 'https://bulma.io/images/placeholders/128x128.png'">
                  </p>
                </figure>
                <div class="media-content">
                  <div class="content">
                    <p class="title is-5 m-b-1_5">{{ primaryTestimonial.role }}</p>
                    <p class="subtitle is-6 has-text-grey">{{ primaryTestimonial.company }}</p>
                    <p><em>“{{ primaryTestimonial.quote }}“</em></p>

                    <a v-bind:href="primaryTestimonial.caseStudy" target="_blank">view success story</a>
                  </div>
                </div>
              </article>
            </div>
  ...
  data () {
    return {
      ...
      testimonials: [{
        ...
        headshot: require('@/assets/images/case-studies/images/david_bosley_openworks.png')
      }, {
        ...
        headshot: require('@/assets/images/case-studies/images/lee_benson_etw.jpg')
      }, {
        company: 'US ChemCare',
        ...
        headshot: require('@/assets/images/case-studies/images/univar.jpg')
      }, {
        ...
        headshot: require('@/assets/images/case-studies/images/seth_myers_air_evac.png')
      }, {
        ...
        headshot: require('@/assets/images/case-studies/images/keir_cochran_small_miracles.jpg')
      }, {
        ...
        headshot: require('@/assets/images/case-studies/images/nate_lowrie_maricopa_health_foundation.png')
      }, {
        ...
        headshot: require('@/assets/images/case-studies/images/barry_kohler_eagle_copters.png')
      }, {
        ...
        headshot: require('@/assets/images/case-studies/images/kevin_humphrey_sunshine.png')
      }, {
        ...
        headshot: require('@/assets/images/case-studies/images/katy_theroux_nci.jpg')
      }, {
        ...
        headshot: require('@/assets/images/case-studies/images/hagen_harker_mid_states.png')
      }, {
        company: 'Use Case',
        ...
        headshot: require('@/assets/images/case-studies/images/charter_schools_vista.png')
      }]

    }
  },

  metaInfo () { return this.$store.getters['meta/showByPage']('customerSuccess') },

                ...
                <Row>
                    <Col>
                        <div className="article-header">
                            <h1>Change management is no joke, and the title can be longer if needed</h1>
                                <div className="article-meta">
                                    <a href="#">Leadership Resources</a>
                                    <span className="article-meta-divider">&bull;</span>
                                    <span>August 8, 2019</span>
                                    <a href="#"><Badge pill variant="info">Culture</Badge></a>
                                </div>
                        </div>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xs={{span: 12, order: 1}} lg={{span:3, order:0}}>
                        <div className="article-author">
                            <div className="article-author-photo" style={{backgroundImage: `url(/lee-benson.jpg)`}}></div>
                            <h4>Lee Benson</h4>
                            <p>
                                Influencer of youth entrepreneurs, guitar maestro, and ETW's Founder + CEO.
                            </p>
                            <CallToAction
                                linkUrl="#"
                                linkName="Full Bio"
                        ...
                        <div className="article-share">
                            ...
                            <a href="#"><img src="/share-facebook.svg" /></a>
                            <a href="#"><img src="/share-twitter.svg" /></a>
                            <a href="#"><img src="/share-linkedin.svg" /></a>
                        </div>
                    </Col>
                    <Col xs={{span: 12, order: 0}} lg={{span:9, order:1}}>
                        ...
                        <Card as="a" href="#" className="article-cta-card border-0 shadow-none">

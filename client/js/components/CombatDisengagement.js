...
const CombatDisengagment = () => {
  return (
    <div className="bg-white py-8 py-lg-11">
        <Container className="combat-disengagement-container">
            <Row className="justify-content-lg-center text-lg-center">
                <Col lg={9}>
                    <h2>Actively disengaged employees cost the US <span className="text-info">$438 billion</span> in lost productivity</h2>
                </Col>
            </Row>
            <Row className="justify-content-lg-center text-lg-center mb-8 mb-lg-10">
                <Col lg={6}>
                    <p className="lead">Though it may not be billions, whatever it’s costing your organization, it’s too much.</p>
                </Col>
            </Row>

            <Row className="combat-disengagement-charts mb-8 mb-lg-11">
                <Col lg={4} className="mb-6 mb-lg-0">
                    <img src="/lack-card-icon.svg" className="mb-7" />
                    <div className="h3"><strong>86%</strong> of CEOs say they <span className="text-sea">lack the talent</span> to execute their business strategies</div>
                    <p className="cite-p">
                        Global Leadership Forecast 2018; DDI, Inc.; The Conference Board Inc., Ernst & Young, LLP
                    </p>
                </Col>
                <Col lg={4} className="mb-6 mb-lg-0">
                    <img src="/not-engaged-card-icon.svg" className="mb-7" />
                    <div className="h3"><strong>85%</strong> of worldwide <span className="text-fire">employees are not engaged</span> or actively disengaged at work</div>
                    <p className="cite-p">
                ...
                <Col lg={4} className="mb-6 mb-lg-0">
                    ...
                    <div className="h3"><strong>78%</strong> of employees believe their leadership team has <span className="text-sun">little to no direction</span></div>
                    <p className="cite-p">
                        Gallup 2017 State of the American Workplace
                    </p>
                </Col>

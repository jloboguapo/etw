...
const Insights = props => {
  return ( <div className="bg-secondary py-8 py-lg-11">
		<Container className="insights-wrapper">
			<Row className="justify-content-md-center text-center">
				<Col lg={8}>
					<h2 className="mb-7">Action-worthy insights</h2>
					<Subscribe/>
				</Col>
			</Row>
			...
			<div className="insights-card-container mt-8 mt-lg-11">
				<CardDeck>
                    <Card className="insight-card">
                        ...
                        <Card.Body>
                            <Card.Title as="a" href="#">Lorem ipsum dolor sit amet, consectetur adipiscing elit</Card.Title>
                            <CallToAction linkUrl="/" linkName="read insight" arrowClassName="arrow-svg" source="arrow.svg"/>
                        </Card.Body>
                    </Card>
                    <Card className="insight-card">
                        ...
                        <Card.Body>
                            <Card.Title>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus pretium mauris nec aliquam porttitor.</Card.Title>
                            <CallToAction linkUrl="/" linkName="read insight" arrowClassName="arrow-svg" source="arrow.svg"/>
                        </Card.Body>
                    </Card>
				</CardDeck>
                    ...
                    <Card className="testimonial-card">
        				<Card.Body>
                            <div className="testimonial-quote">
    							<blockquote>
    								<p>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vivamus pretium mauris nec aliquam porttitor.</p>
    								<footer className="blockquote-footer">Data Buyer at top-tier hedge fund</footer>
    							</blockquote>
    						</div>
    						<div className="testimonial-cta">
    							<Button href="#" variant="primary" className="mb-3">Demo data</Button>
    							<p>It's 100% free for 21 days.</p>
    						</div>
        				</Card.Body>
        			</Card>
				</CardDeck>
                ...
                <p className="text-center mt-9 mb-0">
                    <CallToAction linkUrl="/" linkName="More insights" arrowClassName="arrow-svg" source="arrow.svg"/>
                </p>
			</div>
		</Container>
	</div> );
